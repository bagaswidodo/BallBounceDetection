...
public class PaddlePytaghoran extends JPanel  {
    //status properties
        ...
        this.setPreferredSize(new Dimension(CANVAS_WIDTH, CANVAS_HEIGHT));        
         ...
         public void run() {
             while (true) {
                 ...
                 if (staticBallX > (CANVAS_WIDTH-staticBallRadius) || ballX < staticBallRadius ) {
                     staticBallX = -staticBallSpeedX;
                 }
   ...
   public void paintComponent(Graphics g) {
    ...
    public static void main(String[] args) {
        ...
        frame.setContentPane(new PaddlePytaghoran());
